...
exports.GetApplicationUseCase = void 0;
...
class GetApplicationUseCase {
    ...
    execute(idApplication) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const applicationFound = yield this.applicationSrv.findById(idApplication);
...
exports.GetApplicationUseCase = GetApplicationUseCase;
